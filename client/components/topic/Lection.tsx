			...
			<div>
				...
				<div className='text-wrap h-[630px]'>
					...
					>
						...
						который надо возвести число a, чтобы получить b. Логарифмы были
						придуманы для ускорения и упрощения вычислений.   Идея
						логарифма,  т. е. идея выражать числа в виде степени одного и того
						же основания, принадлежит Михаилу Штифелю.     Но во времена Штифеля
						математика была не столь развита и идея логарифма не нашла своего
						развития.      Логарифмы были изобретены позже одновременно и
						независимо друг от друга шотландским учёным Джоном Непером
						(1550-1617) и швейцарцем Иобстом Бюрги (1552-1632).        Слово
						«логарифм»  происходит от греческих слов logoz и ariumoz - оно
						означает буквально “числа отношений”. Впервые понятие логарифма
						 ввел английский математик  Джон Непер, о чем сообщалось в
						публикации 1614 года, когда была опубликована работа Непера под
						названием «Описание удивительной таблицы логарифмов».
					</textarea>
				</div>
			</div>
