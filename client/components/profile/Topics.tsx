...
const Topics = () => {
	...
	return (
		<div className='relative'>
			...
			<div className='flex flex-col rounded-[22px_22px_0px_0px] justify-start items-center bg-purple p-[25px] h-[525px] overflow-scroll'>
				{/* subject title  */}
				<div className='flex justify-start items-center w-full'>
					<div className='mr-[30px]'>
						<Image src={arrow} width={26} height={32} alt='go back arrow' />
					</div>
					<div className='text-[22px] overflow-hidden'>Математика</div>
				</div>
				{/* groups */}
				<div className='flex justity-start w-full flex-col text-[18px] mt-[10px]'>
					<p className='text-[20px] mb-[15px]'>Группа ИСиП-201</p>
					<div>
						<div>
							<a
							...
							>
								<p className='break-words overflow-hidden'>
									прпорпорпорпропр оорппопорпорппорпо
									Пространственнопостоянныйролрло
								</p>
								<Image
									src={arrowRight}
									width={18}
